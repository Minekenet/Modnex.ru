  ...
  return (
    ...
    >
      <div className="relative w-full aspect-[2/3] overflow-hidden bg-[#1a1b23] mb-4 transition-all duration-300 group-hover:brightness-110 shadow-2xl border border-white/5 rounded-sm">
        ...
        {/* Age Rating - 436-FZ Compliance */}
        <div className="absolute top-3 left-3 z-10 bg-black/60 backdrop-blur-md px-1.5 py-0.5 rounded-sm border border-white/10">
          <span className="text-[10px] font-black text-white/80">16+</span>
        </div>
