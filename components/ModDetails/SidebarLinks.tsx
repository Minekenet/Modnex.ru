...
const SidebarLinks: React.FC = () => {
  const links = [
    { name: 'Официальный Wiki', url: 'https://minecraft.fandom.com/wiki/Minecraft_Wiki' },
    { name: 'YouTube Обзор', url: 'https://youtube.com/watch?v=dQw4w9WgXcQ' },
    { name: 'Discord Сервер', url: 'https://discord.gg/modnex' },
    { name: 'Исходный код', url: 'https://github.com/modnex/example' },
    { name: 'Boosty Поддержка', url: 'https://boosty.to/modnex' }
  ];
        ...
        {links.map((link, i) => (
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <span className="text-[13px] font-bold text-zinc-400 group-hover:text-zinc-200 transition-colors">{link.name}</span>
            </div>
